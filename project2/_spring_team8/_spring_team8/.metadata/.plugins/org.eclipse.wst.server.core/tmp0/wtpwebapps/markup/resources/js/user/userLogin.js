...
// document.getElementById('idbox').addEventListener('click',()=>{
//     document.getElementById('idbox').classList.add('active');
//     document.getElementById('idbox').innerHTML=`아이디 <input type="text" name="id" class="login">`;
// })
// document.getElementById('pwbox').addEventListener('click',()=>{
//     document.getElementById('pwbox').classList.add('active');
//     document.getElementById('pwbox').innerHTML=`비밀번호 <input type="password" pw="pw" class="login">`;
// })
