...
<body>
	...
	<input hidden="hidden" name="${board.bno }">
		...
		<div class="container">
			...
			<div id="carouselExampleIndicators" class="carousel slide"
				...
				<div class="carousel-inner" id="carousel-inner">
					<c:forEach items="${fList}" var="fvo" varStatus="loop">
						...
						<div
							class="carousel-item imgItem <c:if test="${loop.first}">active</c:if>"  data-uuid="${fvo.uuid }">
							<img
								src="/upload/${fn:replace(fvo.saveDir, '\\', '/')}/${fvo.uuid}_${fvo.fileName}"
								class="d-block w-100" alt="..."> <br>
						</div>
				...
				<a class="carousel-control-prev" href="#carouselExampleIndicators"
					role="button" data-bs-slide="prev"  id="prev"> <span
					class="carousel-control-prev-icon" aria-hidden="true"></span> <span
					class="visually-hidden">Previous</span>
				</a> <a class="carousel-control-next"  id="next" href="#carouselExampleIndicators"
			...
			<div class="imageModi">
			<input type="file" class="file-input" id="file" name="files" multiple
			style="display: none">
			
			<button type="button" id="trigger"> 이미지변경 </button> </div>
			</div>
		...
		<div id="boardBox" class="boardBox">
			...
			<table border="1">
				...
				<tr>
					<th><input type="text" name="bno" value="${board.bno }"
						hidden="hidden"></th>
				</tr>
				<tr>
					<th>제목 : <input type="text" name="title" id="title"
						value="${board.title }">
					</th>
				...
				<tr>
					<th>content <textarea rows="10" cols="50"
							placeholder="사람들에게 회원님의 마크업에 대해 설명해 보세요" id="bcontent" name="bcontent"> ${board.bcontent } </textarea>
					</th>
				</tr>
				<tr>
					<th>태그 : <input name='btag' id="btag"
						class='some_class_name' placeholder='write some tags'
						value="${tagList }" data-blacklist='.NET,PHP'> <br>
					</th>
				</tr>
