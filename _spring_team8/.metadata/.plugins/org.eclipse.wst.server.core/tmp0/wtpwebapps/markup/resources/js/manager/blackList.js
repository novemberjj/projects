$(document).ready(function() {
    ...
    $("#comment-table th.oby").click(function() {
      ...
      if ($(this).hasClass("black")) {
        ...
        $("#comment-table th.oby").removeClass("asc desc");
        $(this).addClass(asc1 ? "asc" : "desc");
      } else if ($(this).hasClass("regDate")) {
    ...
    function comparer(index) {
      return function(a, b) {
        ...
        if (index === 7 || index === 9) { // 신고횟수 열의 인덱스는 7, regDate 열의 인덱스는 9
          return $.isNumeric(valA) && $.isNumeric(valB) ? valA - valB : valA.toString().localeCompare(valB);
        } else if (index === 10) { // regDate 열의 인덱스는 10
